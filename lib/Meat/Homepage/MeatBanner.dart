...
class MeatBanner extends StatefulWidget {
  const MeatBanner({super.key});

  @override
  State<MeatBanner> createState() => MeatBannerState();
}

class MeatBannerState extends State<MeatBanner> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      } else if (bannerlist.banner == null || bannerlist.banner["data"]["banner"]["data"].isEmpty) {
        return const SizedBox();
       } else {
        int bannerCount = bannerlist.banner["data"]["banner"]["data"].length;
              ...
              return ClipRRect(
                ...
                child: CachedNetworkImage(
                  ...
                  errorWidget: (context, url, error) =>
                      Image.asset('assets/images/Meat Banner.png', fit: BoxFit.contain),
                  width: MediaQuery.of(context).size.width,
                  imageUrl: bannerlist.banner["data"]["banner"]["data"][index]["imageUrl"],
                  fit: BoxFit.fill,
                ),
              );
            },
