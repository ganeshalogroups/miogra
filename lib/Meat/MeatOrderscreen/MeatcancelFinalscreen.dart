...
class MeatCancelFinalScreen extends StatefulWidget {
  const MeatCancelFinalScreen({super.key});

  @override
  State<MeatCancelFinalScreen> createState() => MeatCancelFinalScreenState();
}

class MeatCancelFinalScreenState extends State<MeatCancelFinalScreen> {
  @override
   @override
