...
class MeatOrderHistoryPaginController extends GetxController {
  ...
  Future<void> getmeatOrdersHistory(int pageKey, 
    ...
    try {
        var response = await http.get( Uri.parse('${API.baseUrl}api/order/orderGetPagination/?subAdminType=meat&userId=$UserId&limit=$perPage&offset=$pageKey&orderStatus=delivered,cancelled,rejected'),
        headers: API().headers,
      );
