...
import 'package:testing/Meat/MeatOrderscreen/MeatOrderHistoryTabbar/MeatTrackorderDetails.dart';
import 'package:testing/Meat/MeatOrderscreen/Meatcancelorderscreen.dart';
...
class MeatTrackorder extends StatefulWidget {
  bool isfromhome;
  String  ordeID;
  dynamic resname;
  dynamic status;
  ...
  @override
  State<MeatTrackorder> createState() => _MeatTrackorderState();
}

class _MeatTrackorderState extends State<MeatTrackorder> {
  ...
  List<StepperData> _buildStepperData() {
    return [
      StepperData(
        title: StepperText("Shop accepted the order", textStyle: _activeIndex >= 1 ? CustomTextStyle.DECORATION_regulartext : CustomTextStyle.chipgrey ),
          ...
          makeSms(phoneNumber: mobileno,message: 'When Will I Get My Order');  
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    InkWell(
                    onTap: () {
                    Get.off(MeatCancelOrderDetails(orderid:orderProvider['_id'], resname: widget.resname, ordercode: widget.ordercode,status:orderState ,), transition: Transition.leftToRight);
                  },
                      child: CustomContainer(
                              decoration: CustomContainerDecoration.greyborder(),
                              child: const Padding(
                      ...
                      Padding(
                        ...
                        onTap: () {
                          ...
                          if( orderState == 'rejected' || orderState == 'cancelled'  ){
                                  ...
                                  AppUtils.showToast('Order $orderState By Shop ');
    
                                  }else  {
    
                                  AppUtils.showToast('Order $orderState By User ');
    
                              }
    
                          } else if(orderState == 'delivered'){
    
                                  AppUtils.showToast('order delivered');
    
                          }  else{
    
                              Get.to(MeatTrackOrderDetails(orderId: widget.ordeID,shoplatlng: widget.shoplatlng,userlat: widget.userlat,orderStatus: widget.status,), transition: Transition.leftToRight);
                          ...
                          // Get.to(SmoothMovingMarkerMap(batchingPlantLatLng:  widget.resturantlatlng,dropLocationLatLng: widget.userlat,vehicleId: widget.ordeID,), transition: Transition.leftToRight);
                        },
                          child: CustomContainer(
