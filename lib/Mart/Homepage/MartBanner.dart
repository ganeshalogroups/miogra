...
class MartBanner extends StatefulWidget {
  const MartBanner({super.key});

  @override
  State<MartBanner> createState() => _MartBannerState();
}

class _MartBannerState extends State<MartBanner> {
  final MartBannerlistcontroller bannerlist = Get.put(MartBannerlistcontroller());

  @override
  void initState() {
    bannerlist.martbannerget();
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
   return Obx(() {
      ...
      } else if (bannerlist.banner == null || bannerlist.banner["data"]["data"].isEmpty) {
            ...
            itemBuilder: (BuildContext context, int index) {
              return ClipRRect(
                ...
                child: CachedNetworkImage(
                  ...
                  imageUrl: bannerlist.banner["data"]["data"][index]["imageUrl"],
                  fit: BoxFit.fill,
                ),
              );
            },
