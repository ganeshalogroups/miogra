...
class ParcelCancelOrderDetails extends StatefulWidget {
  dynamic orderid;
  dynamic packagetype;
  dynamic ordercode;
  dynamic status;
  ...
  @override
  State<ParcelCancelOrderDetails> createState() =>
      _ParcelCancelOrderDetailsState();
}

class _ParcelCancelOrderDetailsState extends State<ParcelCancelOrderDetails> {
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            String instructions =
                                _selectedValue == _options.length - 1
                                    ? _comment
