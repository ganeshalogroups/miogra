...
class _TrackorderState extends State<Trackorder> {
  ...
  List<StepperData> _buildStepperData() {
    return [
      StepperData(
        title: StepperText("Restaurant accepted the order", textStyle: _activeIndex >= 1 ? CustomTextStyle.DECORATION_regulartext : CustomTextStyle.chipgrey ),
        ...
        iconWidget: Container(
          ...
          child: _activeIndex >= 1 ? const Center(child: Icon(Icons.check, size: 13, color: Colors.white)) : null,
          ...
          makeSms(phoneNumber: mobileno,message: 'When Will I Get My Order');  
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    InkWell(
                    onTap: () {
                    Get.off(CancelOrderDetails(orderid:orderProvider['_id'], resname: widget.resname, ordercode: widget.ordercode,status:orderState ,), transition: Transition.leftToRight);
                  },
                      ...
                      Padding(
                        ...
                        onTap: () {
                          ...
                          if( orderState == 'rejected' || orderState == 'cancelled'  ){
                                  ...
                                  AppUtils.showToast('Order $orderState By Resturant ');
