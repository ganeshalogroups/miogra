...
// }
// class _ChatbotState extends State<Chatbot> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
...
//     if (newKeyboardVisible != isKeyboardVisible || bottomInset != keyboardHeight) {
//       setState(() {
//         isKeyboardVisible = newKeyboardVisible;
//         keyboardHeight = bottomInset / WidgetsBinding.instance.window.devicePixelRatio;
//       });
//     }
//   }
...
//   final isTrackOrderFloatingButtonVisible =
//       ordersProvider.orderModel != null &&
//       ordersProvider.orderModel.isNotEmpty;

//   final bottomOffset = isKeyboardVisible
//       ? keyboardHeight + 20
//       : isTrackOrderFloatingButtonVisible ? 200.h : 130.h;
//     // final bottomOffset = isKeyboardVisible
//     //     ? keyboardHeight + 20
//     //     : 210.h;
