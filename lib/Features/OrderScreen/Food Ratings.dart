...
class FoodRatings extends StatefulWidget {
  dynamic status;
  dynamic address;
  dynamic resName;
  dynamic subAdminid;
  ...
  @override
  State<FoodRatings> createState() => _FoodRatingsState();
}

class _FoodRatingsState extends State<FoodRatings> {
