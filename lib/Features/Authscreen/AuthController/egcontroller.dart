...
//           Provider.of<InitializeFavProvider>(cntxt, listen: false).favInitiliteProvider(cntxtt: cntxt);
//           PermissionStatus permission = await location.hasPermission();
//           var servicestatus = await location.serviceEnabled();

//           if (permission == PermissionStatus.granted && servicestatus) {

//             await Get.offAll(RequestPermissionPage(isEnabled: true),transition:Transition.upToDown);

//           } else {

//             await Get.offAll(RequestPermissionPage(isEnabled: false),transition: Transition.upToDown);
...
//             Get.off(RegisterScreen(mobnumber: mobileNo),transition: Transition.leftToRight);
...
//               Get.off(RegisterScreen(user: email),transition: Transition.leftToRight);
