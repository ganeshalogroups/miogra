                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          (offerPercentage != null &&
                                  ...
                                  offerPercentage != 0)
                              ? Text(
                                  " ₹ ${foodIndexvalue.iscustomizable == true ? (foodIndexvalue.customizedFood!.addVariants!.isNotEmpty ? foodIndexvalue.customizedFood!.addVariants![0].variantType![0].customerPrice : foodIndexvalue.customizedFood!.addOns![0].addOnsType![0].customerPrice).toString() : foodIndexvalue.food!.customerPrice}",
                                  style: TextStyle(
                                      fontSize: 14.h,
                                      fontWeight: FontWeight.w500,
                              ...
                              : Obx(() {
                                  if (redirect.isredirectLoading.isTrue) {
                                    ...
                                    return Row(
                                      ...
                                      children: [
                                        Text(
                                          " ₹${foodIndexvalue.iscustomizable == true ? (foodIndexvalue.customizedFood!.addVariants!.isNotEmpty ? foodIndexvalue.customizedFood!.addVariants![0].variantType![0].customerPrice.toString() : foodIndexvalue.customizedFood!.addOns![0].addOnsType![0].customerPrice.toString()) : foodIndexvalue.food!.customerPrice.toString()}",
                                    ...
                                    return Text(
                                      " ₹${foodIndexvalue.iscustomizable == true ? (foodIndexvalue.customizedFood!.addVariants!.isNotEmpty ? foodIndexvalue.customizedFood!.addVariants![0].variantType![0].customerPrice : foodIndexvalue.customizedFood!.addOns![0].addOnsType![0].customerPrice).toString() : foodIndexvalue.food!.customerPrice.toString()}",
                                      style: TextStyle(
                                          fontSize: 14.h,
                                          fontWeight: FontWeight.w500,
                                          color: Customcolors.DECORATION_BLACK,
