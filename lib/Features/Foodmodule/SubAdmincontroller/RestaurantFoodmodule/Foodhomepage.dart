...
import 'package:testing/Features/Foodmodule/SubAdmincontroller/RestaurantFoodmodule/INactiveRestaurantcard.dart';
...
import 'package:testing/Features/Foodmodule/SubAdmincontroller/RestaurantFoodmodule/RestaurantItem.dart';
...
class Foodscreen extends StatefulWidget {
 final String categoryFilter;
  ...
  const Foodscreen(
      ...
      this.isfrommanualsearchaddress = false,  this.categoryFilter=""});
...
class _FoodscreenState extends State<Foodscreen> {
  ...
  List<Map<String, dynamic>> explore_items = [
    {
      ...
      "img": "assets/images/restauranthome.png"
    },
    {
      "name": "Shop",
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      // Provider.of<HomepageProvider>(context, listen: false).getHomepagedatas();
       ...
       Provider.of<HomepageProvider>(context, listen: false).getHomepagedatas(categoryFilter: nearbyreget.selectedIndex.value==0?"restaurant":"shop");
 ...
 redirect.getredirectDetails(); //1
                  ...
                  Expanded(
                    child: Row(
                     ...
                     //   Image.asset(othersicon, scale: 3),
                        Image.asset("assets/images/location.png", height: 22.h,),
      ...
      onPressed: () {
        showDialog(
          ...
          builder: (_) => LoginRequiredDialog(
            ...
            content: "Please login to view your items in your cart.",
            cancelText: "Later",
            confirmText: "Log In",
            onConfirm: () {
  ...
  //       ),
                    ...
                    child: Image.asset("assets/images/dddd.png",height: 22.h,)
...
Container(padding: EdgeInsets.all(20),
  ...
  decoration: BoxDecoration(
    color: nearbyreget.selectedIndex.value == index
